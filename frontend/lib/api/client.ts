...
export const installationsApi = {
  ...
  async getInstallation(id: number, token: string) {
    return apiFetch<Installation>(`/api/installations/${id}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async createInstallation(data: InstallationCreate, token: string) {
    return apiFetch<Installation>(`/api/installations`, {
      method: "POST",
  ...
  async activateInstallation(id: number, token: string) {
    return apiFetch<Installation>(`/api/installations/${id}/activate`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${token}`,
      },
  ...
  async deactivateInstallation(id: number, token: string) {
    return apiFetch<Installation>(`/api/installations/${id}/deactivate`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${token}`,
      },
  ...
  async deleteInstallation(id: number, token: string) {
    return apiFetch<void>(`/api/installations/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
      },
  ...
  async getLiveData(id: number, token: string) {
    return apiFetch<any>(`/api/installations/${id}/live`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const epexApi = {
  async getPrices(
    params: { start?: string; end?: string; region?: string },
    token: string,
  ) {
    const queryParams = new URLSearchParams();
    if (params.start) queryParams.set("start", params.start);
    ...
    return apiFetch<any>(`/api/epex/prices?${queryParams.toString()}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async getForecast(token: string) {
    return apiFetch<any>("/api/epex/prices/forecast", {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const usersApi = {
  async getUsers(
    ...
    return apiFetch<UserList>(`/api/users?${params.toString()}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async createUser(data: UserCreate, token: string) {
    return apiFetch<UserCredentials>(`/api/users`, {
      method: "POST",
      body: JSON.stringify(data),
      headers: {
        Authorization: `Bearer ${token}`,
  ...
  async activateUser(userId: number, token: string) {
    return apiFetch<User>(`/api/users/${userId}/activate`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${token}`,
      },
  ...
  async deactivateUser(userId: number, token: string) {
    return apiFetch<User>(`/api/users/${userId}/deactivate`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export const systemSettingsApi = {
  async getReverseSSHSettings(token: string) {
    return apiFetch<ReverseSSHSettings>(`/api/system-settings/reverse-ssh`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const firmwareApi = {
  async listFirmware(token: string) {
    return apiFetch<FirmwareList>(`/api/firmware`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async getFirmware(firmwareId: number, token: string) {
    return apiFetch<Firmware>(`/api/firmware/${firmwareId}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async deleteFirmware(firmwareId: number, token: string) {
    return apiFetch<void>(`/api/firmware/${firmwareId}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
      },
